      ...
      <div className="max-w-[1440px] mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
          <div className="lg:w-1/2">
            ...
            <h2 className="text-xl lg:text-3xl font-black mb-6 leading-tight text-gray-900 tracking-tight">
        ...
        <div className="text-center mb-16 px-4 max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-gray-900 tracking-tight leading-tight">
            Our Services <span className="text-green-600">Include</span>
          </h2>
          <div className="w-20 h-1.5 bg-green-600 mx-auto mt-6 rounded-full"></div>
        </div>
