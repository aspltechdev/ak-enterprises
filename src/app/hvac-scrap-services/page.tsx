                ...
                <section className="relative min-h-[50vh] md:min-h-[75vh] flex items-end overflow-hidden bg-gray-900 pb-16 md:pb-28 pt-24">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-4xl text-left">
                            ...
                            >
                                HVAC <br />
                                <span className="text-green-400">Scrap Services</span>
                            </motion.h1>
                ...
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-10 md:mb-16">
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 text-center leading-[1.1]">Our HVAC Scrap Services Include</h2>
                        </div>
                ...
                <section className="py-16 md:py-24 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12 md:mb-20">
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 text-center leading-[1.1]">Structured HVAC Scrap Removal Process</h2>
                        </div>
