...
import { CheckCircle2, ArrowRight, Building2, Wind, Snowflake, Thermometer, Fan, Settings, ShieldCheck, Factory, ClipboardList, FileText, Wrench, MessageSquare, Recycle } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { Metadata } from "next";

export const metadata: Metadata = {
    title: "HVAC Scrap Buyers | Large-Scale AC & Chiller Scrap – AK Enterprises",
    description: "AK Enterprises provides large-scale HVAC scrap services including AC and chiller dismantling with safe handling and transparent pricing.",
};

export default function HvacScrapService() {
    const serviceHighlights = [
        {
            title: "Bulk air conditioner (AC) scrap",
            icon: Wind,
        },
        {
            title: "Chiller AC and industrial cooling systems",
            icon: Snowflake,
        },
        {
            title: "Centralized HVAC units",
            icon: Thermometer,
        },
        {
            title: "Commercial cooling equipment",
            icon: Fan,
        },
        {
            title: "Associated metal and electrical components",
            icon: Settings,
        },
    ];

    const whyChooseUs = [
        "Specialized in Large-Scale HVAC dismantling",
        "Equipped for heavy and complex system removal",
        "Transparent pricing & accurate weighing",
        "Safety-focused execution with trained professionals",
        "Environmentally responsible scrap processing",
    ];

    const processSteps = [
        {
            title: "System Evaluation",
            description: "Assessment of HVAC type, size, and dismantling requirements.",
            icon: ClipboardList,
        },
        {
            title: "Quotation & Planning",
            description: "Clear pricing and step-by-step execution plan for large-scale HVAC removal.",
            icon: FileText,
        },
        {
            title: "Dismantling & Clearance",
            description: "Safe dismantling of AC and chiller units using proper equipment.",
            icon: Wrench,
        },
        {
            title: "Final Handover",
            description: "Clean site handover with complete scrap removal.",
            icon: CheckCircle2,
        },
    ];
                ...
                <section className="relative py-10 md:py-16 lg:py-20 bg-gray-900 text-white overflow-hidden flex items-center min-h-[25vh] md:min-h-[35vh]">
                    ...
                    <div className="container mx-auto px-4 relative z-10 text-center">
                        <h1 className="text-3xl md:text-5xl lg:text-7xl font-black mb-4 md:mb-6 leading-tight max-w-5xl mx-auto tracking-tighter text-center">
                            HVAC Scrap Buyers for <span className="text-green-500">Large-Scale Cooling Systems</span>
                        </h1>
                        <p className="text-base md:text-lg lg:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed text-center">
                            AK Enterprises provides professional HVAC scrap services for factories, commercial buildings, hospitals, malls, and industrial facilities.
                        </p>
                    </div>
                </section>
                            ...
                            <div className="w-full lg:w-2/3">
                                <div className="space-y-6 lg:space-y-8 text-gray-700 leading-relaxed">
                                    ...
                                    <p className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 leading-tight">
                                        We specialize in large-scale HVAC scrap dismantling, handling heavy air-conditioning units and complex cooling systems safely and efficiently.
                                    </p>
                                    <p className="text-base md:text-lg lg:text-xl font-medium text-gray-600">
                                        From standard AC units to industrial chiller systems, our team manages bulk HVAC scrap removal with proper equipment, safety protocols, and transparent valuation.
                                    </p>

                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-gray-100">
                                        {[
                                            { title: "Expert Handling", desc: "Specialized in large cooling systems", icon: ShieldCheck },
                                            { title: "Safe Disposal", desc: "Eco-compliant recycling", icon: Recycle },
                                            { title: "Bulk Capacity", desc: "Equipped for heavy industrial loads", icon: Factory }
                                        ].map((item, i) => (
                    ...
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
                            <div className="lg:w-1/2">
                                <h2 className="text-green-600 font-extrabold uppercase tracking-tight mb-4 text-xl md:text-2xl lg:text-3xl text-left">HVAC Scrap Services</h2>
                                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 lg:mb-8 text-gray-900 text-left">
                                    Professional Dismantling of Large-Scale HVAC Systems
                                </h3>
                                <div className="space-y-4 lg:space-y-6 text-gray-600 text-base md:text-lg text-left">
                                    <p>
                                        HVAC systems are heavy, complex, and require skilled handling — especially when dealing with large commercial or industrial installations. AK Enterprises ensures structured dismantling, secure removal, and efficient clearance of HVAC scrap without disrupting site operations.
                                    </p>
                                    <p>
                                        Our approach prioritizes safety, precision, and maximum value recovery.
                                    </p>
                                </div>
                            </div>
                            <div className="lg:w-1/2 relative h-64 sm:h-[400px] w-full rounded-[2rem] md:rounded-3xl overflow-hidden shadow-2xl">
                                <Image
                                    src="/assets/subpages images/acscraps.jpg"
                                    alt="Industrial Chiller Dismantling"
                                    fill
                                    className="object-cover"
                                    priority
                                />
                ...
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-10 md:mb-16">
                            <h2 className="text-green-600 font-extrabold uppercase mb-4 text-xl md:text-2xl lg:text-3xl text-center">Types of HVAC Scrap We Buy</h2>
                            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 text-center">Our HVAC Scrap Services Include:</h3>
                        </div>
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1440px] mx-auto">
                            ...
                            <div className="p-4 sm:p-8 flex flex-col justify-center col-span-2 sm:col-span-1 text-center">
                                <p className="text-base sm:text-xl font-bold italic text-green-600 leading-relaxed text-left sm:text-center">
                                    "All HVAC scrap is handled using industry-grade tools and trained manpower."
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-16 md:py-24 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12 md:mb-16">
                            ...
                            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 text-center">Structured HVAC Scrap Removal Process</h3>
                        </div>
                    ...
                    <div className="container mx-auto px-4 max-w-7xl relative z-10">
                        <div className="bg-green-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10 text-center">
                                <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight text-center">Need Large-Scale HVAC Scrap Clearance?</h2>
                                <p className="text-lg md:text-xl font-medium text-green-50 mb-10 max-w-3xl mx-auto leading-relaxed text-center">
                                    Choose AK Enterprises for professional HVAC dismantling, fair pricing, and compliant scrap disposal.
                                </p>
                                ...
                                <p className="mt-8 text-green-100 font-bold italic text-center">
                                    👉 Get a complete HVAC clearance solution today!
                                </p>
                            </div>
                        </div>
                    </div>
