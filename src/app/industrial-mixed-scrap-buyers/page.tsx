...
import { CheckCircle2, ArrowRight, Building2, Hammer, Zap, Divide, Cpu, Warehouse, ShieldCheck, Factory, ClipboardList, FileText, Wrench, MessageSquare, Recycle } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { Metadata } from "next";

export const metadata: Metadata = {
    title: "Industrial Scrap Buyers | Mixed Scrap Removal – AK Enterprises",
    description: "AK Enterprises buys large-scale industrial and mixed scrap including metal, electrical, and parallel scrap with efficient handling.",
};

export default function IndustrialMixedScrapService() {
    const serviceHighlights = [
        {
            title: "Metal scrap (bulk quantities)",
            icon: Hammer,
        },
        {
        ...
        {
            title: "Parallel scrap (mixed industrial materials)",
            icon: Divide,
        },
        {
            title: "Machinery-related scrap",
            icon: Cpu,
        },
        {
            title: "Factory and warehouse scrap",
            icon: Warehouse,
        },
    ];

    const whyChooseUs = [
        "Experience with complex mixed scrap projects",
        "Capacity to handle bulk industrial scrap volumes",
        "Trained workforce and industrial equipment",
        "Clear pricing and transparent weighing",
    ...
    const processSteps = [
        {
            ...
            description: "Detailed evaluation of scrap type and quantity.",
            icon: ClipboardList,
        },
        {
            title: "Quotation & Execution Plan",
            description: "Customized pricing for large-volume scrap.",
            icon: FileText,
        },
        {
            title: "Segregation & Removal",
            description: "Organized handling of mixed scrap materials.",
            icon: Wrench,
        },
        {
            title: "Final Clearance",
            description: "Clean and compliant site handover.",
            icon: CheckCircle2,
        },
    ];
    ...
    const industries = [
        ...
        "Industrial parks",
        "Power & infrastructure facilities",
        ...
        <div className="min-h-screen font-sans bg-white">
            ...
            <main className="pt-[64px]">
                ...
                <section className="relative py-10 md:py-16 lg:py-20 bg-gray-900 text-white overflow-hidden flex items-center min-h-[25vh] md:min-h-[35vh]">
                    <div className="absolute inset-0 z-0 text-center text-center text-center">
                        <Image
                    ...
                    <div className="container mx-auto px-4 relative z-10 text-center">
                        <h1 className="text-3xl md:text-5xl lg:text-7xl font-black mb-4 md:mb-6 leading-tight max-w-5xl mx-auto tracking-tighter text-center">
                            Industrial & Mixed Scrap Buyers for <span className="text-green-500">Large-Scale Projects</span>
                        </h1>
                        <p className="text-base md:text-lg lg:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed text-center">
                            AK Enterprises is a reliable buyer of industrial and mixed scrap from factories, warehouses, and large commercial facilities.
                        </p>
                    </div>
                </section>
                        ...
                        <div className="flex flex-col lg:flex-row gap-12 items-center">
                            <div className="w-full lg:w-2/3">
                                <div className="space-y-6 lg:space-y-8 text-gray-700 leading-relaxed text-left">
                                    ...
                                    <p className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 leading-tight">
                                        We specialize in managing Large-Scale scrap clearance that includes metal, electrical, and parallel scrap materials.
                                    </p>
                                    <p className="text-base md:text-lg lg:text-xl font-medium text-gray-600">
                                        With the capability to handle complex scrap categories at scale, we ensure organized segregation, fair valuation, and efficient removal, making us a preferred partner for industrial scrap disposal across large projects.
                                    </p>

                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-gray-100">
                                        {[
                                            { title: "Organized Disposal", desc: "Expert segregation of mixed scrap", icon: ShieldCheck },
                                            { title: "Safe & Compliant", desc: "Meeting all industrial norms", icon: Recycle },
                                            { title: "Bulk Clearance", desc: "Equipped for massive industrial projects", icon: Factory }
                                        ].map((item, i) => (
                            ...
                            <div className="w-full lg:w-1/3">
                                <div className="relative h-64 md:h-80 lg:h-[450px] w-full max-w-md mx-auto rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white group">
                                    <Image
                                        src="/assets/services/gas2.jpeg"
                                        alt="Industrial Project Scrap"
                                        fill
                ...
                {/* Industrial & Mixed Scrap Services (H2) */}
                <section className="py-12 md:py-24 bg-gray-50 overflow-hidden">
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
                            <div className="lg:w-1/2 lg:text-left">
                                <h2 className="text-green-600 font-extrabold uppercase tracking-tight mb-4 text-xl md:text-2xl lg:text-3xl text-left">Industrial & Mixed Scrap Services</h2>
                                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 lg:mb-8 text-gray-900 text-left">
                                    Complete Industrial Scrap Handling at Scale
                                </h3>
                                <div className="space-y-4 lg:space-y-6 text-gray-600 text-base md:text-lg text-left">
                                    <p>
                                        Industrial scrap often includes a combination of materials that require structured handling. AK Enterprises provides end-to-end industrial scrap solutions, from assessment to final clearance, without disrupting ongoing operations.
                                    </p>
                                    <p>
                                        Our systems are designed for large-scale scrap volumes, ensuring safety, speed, and compliance.
                                    </p>
                                </div>
                            </div>
                            <div className="lg:w-1/2 relative h-64 sm:h-[400px] w-full rounded-[2rem] md:rounded-3xl overflow-hidden shadow-2xl">
                                <Image
                                    src="/assets/services/gas3.jpeg"
                                    alt="Factory Scrap Site"
                                    fill
                                    className="object-cover"
                                    priority
                                />
                ...
                {/* Types of Industrial & Mixed Scrap (H2) */}
                <section className="py-12 md:py-24 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-10 md:mb-16">
                            <h2 className="text-green-600 font-extrabold uppercase mb-4 text-xl md:text-2xl lg:text-3xl text-center">Our Scrap Categories Include</h2>
                            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 text-center">Each category is processed with accurate segregation and transparent pricing.</h3>
                        </div>
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-[1440px] mx-auto">
                            ...
                            <div className="p-4 sm:p-8 flex flex-col justify-center col-span-2 sm:col-span-1 text-center text-center">
                                <p className="text-base sm:text-xl font-bold italic text-green-600 leading-relaxed text-left sm:text-center">
                                    "We handle all industrial categories from bulky metal to complex electrical parallel scrap."
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-16 md:py-24 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12 md:mb-16">
                            ...
                            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 text-center">Streamlined Industrial Scrap Removal Process</h3>
                        </div>
                    ...
                    <div className="container mx-auto px-4 max-w-7xl relative z-10">
                        <div className="bg-green-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10 text-center">
                                <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight text-center text-center">Looking for Trusted Industrial Scrap Buyers?</h2>
                                <p className="text-lg md:text-xl font-medium text-green-50 mb-10 max-w-3xl mx-auto leading-relaxed text-center">
                                    Partner with AK Enterprises for professional, large-scale industrial and mixed scrap purchasing.
                                </p>
                                ...
                                <p className="mt-8 text-green-100 font-bold italic text-center">
                                    👉 Get a complete industrial scrap solution today!
                                </p>
                            </div>
                        </div>
                    </div>
